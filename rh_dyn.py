...
# -*- coding: utf-8 -*-
"""
Created on Sun Sep  4 21:37:50 2022
...
input_data = r'/DS1/xshome/fuzh19/nc/600s.nc'
...
def dyc1(t,ax):
    ...
    levels = np.arange(2,8+0.01,0.3)
    cb = ax.contourf(lon2d,lat2d,u_all,levels=levels,cmap='Greens',extend='both')
...
def dyc3(t,ax):
    ...
    if t==0:
        ...
        cbar=fig.colorbar(cb,cax=position,orientation='horizontal',ticks=np.arange(2,8+0.001,1),
...
np.save('./rh.npy',gh)
plt.savefig('dyn4.eps', format="eps", bbox_inches = 'tight',pad_inches=0,dpi=600)
